...
<div class='w3-card w3-container w3-animate-zoom w3-hover-gray w3-deep-orange' style='min-height:150px; margin : 70px'>
 <div class="w3-middle w3-xxlarge w3-monospace" style="margin-top: 50px;">New Orders</div>
</div>
</div>
</a>
...
<div class="w3-card w3-container" style="min-height:100px">
<div class='w3-card w3-container w3-animate-zoom w3-hover-gray w3-deep-orange' style='min-height:150px; margin : 70px'>
 <div class="w3-middle w3-xxlarge w3-monospace" style="margin-top: 50px;">Assigned Orders</div>
</div>
</div>
</a>
